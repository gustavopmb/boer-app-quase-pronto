...
function VProdutos({ navigation }) {
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff' }}>
      ...
      <Image source={p01} style={{ width: 100, height: 100, marginBottom: 20 }} resizeMode="contain" />
      <Text style={{ fontSize: 12, marginBottom: 20 }}>Carretilha (D)</Text>
      <Image source={p02} style={{ width: 100, height: 100, marginBottom: 20 }} resizeMode="contain" />
      <Text style={{ fontSize: 12, marginBottom: 20 }}>Lambari (8uni.)</Text>
      <Image source={p03} style={{ width: 100, height: 100, marginBottom: 20 }} resizeMode="contain" />
      <Text style={{ fontSize: 12, marginBottom: 20 }}>Linha Multifilamento</Text>
      <Image source={p04} style={{ width: 100, height: 100, marginBottom: 20 }} resizeMode="contain" />
      <Text style={{ fontSize: 12, marginBottom: 20 }}>Zig-Zarinha (Isca Artificial)</Text>
    </View>
  );
}
